...
import { signatureHoodiePreview } from '../fixtures/signature-hoodie-preview.js';
...
describe('commerce product presentation', () => {
  it('keeps local review captions provider-neutral while disclosing AI assistance', () => {
    const visibleMediaCopy = signatureHoodiePreview.media
      .flatMap(item => [item.alt, item.label])
      .join(' ');

    expect(visibleMediaCopy).toContain('AI-assisted');
    expect(visibleMediaCopy).toContain('Draft review');
    expect(visibleMediaCopy.toLowerCase()).not.toMatch(/shopify|modelize|apliiq|generated by/);
  });
